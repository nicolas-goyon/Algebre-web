...
export class Intersection extends Noeud {
	...
	static fromJson(data: JsonOperation): Intersection {
		...
		// }
		let inter = new Intersection(null, null, null)
		if (data.relation1 !== undefined) {
			inter.ensemble1 = fromJsonNextNode(data.relation1)
		}
		if (data.relation2 !== undefined) {
			inter.ensemble2 = fromJsonNextNode(data.relation2)
		}
