...
import { Home, Logout, Playground, SignIn, SignUp, Workspaces, Workspace, WorspaceLoader, CreateWorkspace, Exerciceliste, CreateExercice, Exercice, ExerciceLoader } from './Pages';
